...
const TourGuiderCard = ({ tourGuider, onView }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 sm:transform sm:hover:scale-105">
      {/* Header with Avatar */}
      <div className="relative h-32 sm:h-40 bg-gradient-to-r from-blue-500 to-purple-600 overflow-hidden flex-shrink-0">
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-grow">
        ...
        {/* Gender and Age */}
        <div className="flex items-center space-x-2 mb-2 sm:mb-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
        ...
        {/* Experience */}
        <div className="flex items-center space-x-2 mb-2 sm:mb-3 text-xs sm:text-sm text-gray-700 dark:text-gray-300">
          <Briefcase className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-600 dark:text-purple-400 flex-shrink-0" />
        ...
        {/* Location */}
        <div className="flex items-center space-x-2 mb-3 sm:mb-4 text-xs sm:text-sm text-gray-700 dark:text-gray-300">
        ...
        {/* Description Preview */}
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 line-clamp-2 mb-3 sm:mb-4 flex-grow">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 px-4 py-2.5 sm:py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-300 font-medium text-sm sm:text-base flex-shrink-0"
        >

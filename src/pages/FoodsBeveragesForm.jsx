...
const categoryOptions = [
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.message || 'Failed to publish foods & beverages');
      }
    } catch (error) {
      console.error('Error publishing foods & beverages:', error);
      setError('Failed to publish foods & beverages. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-2">
              Publish Your Foods & Beverages
            </h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Share your food and beverage products with customers
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:flex-1 px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 transition-colors font-medium flex items-center justify-center space-x-2 text-sm sm:text-base"
            >
              {loading ? (
                <>
      ...
      {showSuccessModal && (
        <SuccessModal
          title="Foods & Beverages Published Successfully!"
          message="Your foods & beverages advertisement has been published and is now live. You can manage it from your advertisements page."
...
export default FoodsBeveragesForm;

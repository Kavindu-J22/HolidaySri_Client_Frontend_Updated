...
const CreativePhotographersForm = () => {
  ...
  useEffect(() => {
    const fetchProvinces = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/creative-photographers/provinces');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/creative-photographers/publish', {
        method: 'POST',
        headers: {

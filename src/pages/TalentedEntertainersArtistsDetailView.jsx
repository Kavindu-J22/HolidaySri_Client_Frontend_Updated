...
import { ArrowLeft, Star, MapPin, Phone, Mail, Facebook, Globe, Loader, AlertCircle, Share2, X, Copy, CheckCircle } from 'lucide-react';
...
const TalentedEntertainersArtistsDetailView = () => {
  ...
  const handleShare = (platform) => {
    ...
    const title = `Check out ${profile?.name} - Talented Entertainer & Artist on HolidaySri`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-4 sm:py-8 px-3 sm:px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
          {/* Hero Section */}
          <div className="h-48 sm:h-64 bg-gradient-to-br from-blue-400 to-indigo-600 overflow-hidden">
            {profile.avatar?.url && (
              <img

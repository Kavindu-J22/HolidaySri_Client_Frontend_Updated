  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.message || 'Failed to publish cafe/restaurant');
      }
    } catch (error) {
      console.error('Error publishing cafe/restaurant:', error);
      setError('Failed to publish cafe/restaurant. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-2">
              Publish Your Cafe & Restaurant
            </h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Share your restaurant details and attract more customers
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:flex-1 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 text-sm sm:text-base"
            >
              {loading ? (
                <>
      ...
      <SuccessModal
        ...
        title="Success!"
        message="Your cafe/restaurant has been published successfully!"
...
export default CafesRestaurantsForm;

...
const EmergencyServicesInsuranceForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-4 sm:py-6 lg:py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 space-y-3 sm:space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-red-500 focus:border-transparent transition-all"
              maxLength={200}
            />
          </div>
          ...
          <div className="grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-red-500 focus:border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-red-500 focus:border-transparent transition-all resize-none"
              maxLength={3000}
            />
          ...
          <div>
            ...
            {!logo.url ? (
              <div className="border-gray-300 dark:border-gray-600 rounded-lg p-4 sm:p-6 lg:p-8 text-center hover:border-red-500 dark:hover:border-red-400 transition-colors">
                <input
                  type="file"
                  accept="image/*"
                ...
                >
                  {logo.uploading ? (
                    <>
                      <Loader className="w-10 h-10 sm:w-12 sm:h-12 text-red-500 animate-spin mb-3" />
              ...
              <div className="relative inline-block">
                <img
                  src={logo.url}
                  alt="Logo"
                  className="w-48 h-48 object-contain rounded-lg border-gray-200 dark:border-gray-600"
                />
                <button
                  type="button"
                  onClick={removeLogo}
                  className="absolute -right-2 p-1 bg-red-500 text-white rounded-full hover:bg-red-600 transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
          ...
          <div className="flex space-x-4 pt-6">
            ...
            <button
              ...
              className="px-3 sm:px-3 md:px-6 py-2.5 sm:py-3 sm:text-base bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg hover:from-red-600 hover:to-pink-600 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
              {loading ? (
                <>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-4 sm:p-6 lg:p-8 text-center animate-scale-in">
            ...
            <div className="flex space-x-3">
              <button
                onClick={() => navigate('/profile', { state: { activeSection: 'advertisements' } })}
                className="flex-1 px-4 sm:px-4 md:px-6 py-2.5 sm:py-3 sm:text-base bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg hover:from-red-600 hover:to-pink-600 transition-all font-medium"
              >

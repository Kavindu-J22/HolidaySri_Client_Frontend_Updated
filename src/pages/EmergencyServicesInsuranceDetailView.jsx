...
const EmergencyServicesInsuranceDetailView = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      ...
      try {
        const response = await fetch(`http://localhost:5000/api/emergency-services-insurance/${id}/reviews`);
        const data = await response.json();
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Refresh reviews
        const reviewsResponse = await fetch(`http://localhost:5000/api/emergency-services-insurance/${id}/reviews`);
        ...
        const profileResponse = await fetch(`http://localhost:5000/api/emergency-services-insurance/${id}`);

...
import {
  ...
  Award, TrendingUp, Share2, X, Copy
} from 'lucide-react';
...
const EmergencyServicesInsuranceDetailView = () => {
  ...
  const handleShare = (platform) => {
    ...
    const title = `Check out ${profile?.name} - Emergency Services & Insurance on HolidaySri`;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition shadow-md"
          >
        ...
        {/* Success Message */}
        {successMessage && (
          <div className="mb-4 sm:mb-6 bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-3 sm:p-4 rounded flex items-center">

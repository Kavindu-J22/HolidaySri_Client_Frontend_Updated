...
import { ArrowLeft, Star, Loader, AlertCircle, Send, MapPin, Phone, Globe, Facebook, Heart, Share2, X, MessageCircle, Copy } from 'lucide-react';
...
const ExclusiveGiftPacksDetailView = () => {
  ...
  const handleShare = (platform) => {
    ...
    const title = `Check out ${giftPack?.name} - Exclusive Gift Pack on HolidaySri`;
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between">
          ...
          <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white truncate mx-2">{giftPack.name}</h1>
          <button
      ...
      {shareSuccess && (
        <div className="max-w-6xl mx-auto px-3 sm:px-4 pt-4">
          <div className="p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-2 sm:gap-3">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {giftPack.images && giftPack.images.length > 0 && (
              <div className="mb-6 sm:mb-8">
                <div className="relative bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden h-64 sm:h-80 md:h-96 mb-3 sm:mb-4">
                  <img
            ...
            {/* Details */}
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8">
              <div className="mb-4 sm:mb-6">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">{giftPack.name}</h2>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">{giftPack.specialization}</p>
              </div>
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">{giftPack.description}</p>
              </div>

              {giftPack.includes && giftPack.includes.length > 0 && (
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3">What's Included</h3>
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">{giftPack.category}</p>
              </div>

              <div className="mb-4 sm:mb-6">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2 sm:mb-3">Availability</h3>
                <p className={`text-base sm:text-lg font-semibold ${giftPack.available ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Reviews</h3>
                <button
              ...
              {showReviewForm && (
                <form onSubmit={handleSubmitReview} className="mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <button
                    ...
                    className="w-full px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center gap-2 text-sm sm:text-base"
                  >
                    {submittingReview ? (
                      <>
              ...
              {giftPack.reviews && giftPack.reviews.length > 0 ? (
                <div className="space-y-3 sm:space-y-4">
                  {giftPack.reviews.map((review, idx) => (
                    <div key={idx} className="border-b border-gray-200 dark:border-gray-700 pb-3 sm:pb-4 last:border-b-0">
                      ...
                      <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">{review.reviewText}</p>
                    </div>
                  ))}
                </div>
              ) : (
                <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 text-center py-6 sm:py-8">No reviews yet. Be the first to review!</p>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            {/* Contact Card */}
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6 lg:sticky lg:top-24">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                >
                  ...
                  <span className="text-sm sm:text-base text-gray-700 dark:text-gray-300 truncate">{giftPack.contact}</span>
                </a>

                {/* Location */}
                <div className="flex items-center space-x-2 sm:space-x-3 p-2.5 sm:p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
                  <div className="text-gray-700 dark:text-gray-300 min-w-0">
                    <p className="text-xs sm:text-sm truncate">{giftPack.location.city}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{giftPack.location.province}</p>
                  </div>
                </div>
                ...
                {giftPack.website && (
                  ...
                  >
                    ...
                    <span className="text-sm sm:text-base text-gray-700 dark:text-gray-300 truncate">Visit Website</span>
                  </a>
                )}
                ...
                {giftPack.facebook && (
                  ...
                  >
                    ...
                    <span className="text-sm sm:text-base text-gray-700 dark:text-gray-300 truncate">Follow on Facebook</span>
                  </a>
                )}
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-3 sm:p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Share this gift pack</h3>
              <button

...
const EditCafesRestaurants = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch provinces
        const provincesRes = await fetch('http://localhost:5000/api/cafes-restaurants/provinces');
        ...
        // Fetch cafe data
        const cafeRes = await fetch(`http://localhost:5000/api/cafes-restaurants/${id}`);

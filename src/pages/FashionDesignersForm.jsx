...
const FashionDesignersForm = () => {
  ...
  useEffect(() => {
    const fetchProvinces = async () => {
      try {
        const response = await fetch('https://holidaysri-backend-9xm4.onrender.com/api/fashion-designers/provinces');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://holidaysri-backend-9xm4.onrender.com/api/fashion-designers/publish', {
        method: 'POST',
        headers: {

...
const EditCryptoConsultingSignalsForm = () => {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setFormData({
            ...
            physical: profile.physical || false,
          ...
          if (profile.coursesPDF) {
            setCoursesPDF({
              url: profile.coursesPDF.url || '',
              publicId: profile.coursesPDF.publicId || '',
              uploading: false,
              fileName: 'Courses Details.pdf'
            });
          }
        }
      } catch (err) {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Update your crypto consulting or signals service
          </p>
        </div>
...
export default EditCryptoConsultingSignalsForm;

    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Your professional lawyer profile has been published successfully!
        </p>
        <button
          onClick={() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 sm:py-6 lg:py-8">
      <div className="max-w-4xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 px-2">
              Share your legal expertise and connect with clients
            </p>
          </div>
        </div>
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 lg:p-8">
          {/* Avatar Upload */}
          <div className="mb-8">
            ...
            <div className="flex items-center space-x-6">
              ...
              <label className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors cursor-pointer">
                ...
                <span>{images.avatar.uploading ? 'Uploading...' : 'Upload Photo'}</span>
                <input
                  type="file"
                  accept="image/*"
          ...
          <button
            ...
            className="w-full px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors font-semibold flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
...
export default ProfessionalLawyersForm;

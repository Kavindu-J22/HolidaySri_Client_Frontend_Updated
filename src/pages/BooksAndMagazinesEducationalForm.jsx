...
const BooksAndMagazinesEducationalForm = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-4 sm:py-6 lg:py-8 px-3 sm:px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white flex items-center space-x-2">
                ...
                <span>Publish Book/Magazine</span>
              </h1>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">Share your educational content</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
          ...
          {/* Specializations */}
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Specializations</h2>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 sm:px-4 py-2 sm:py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2"
              >
            ...
            <div className="flex flex-wrap gap-2">
              {formData.specialization.map((spec, idx) => (
                <span key={idx} className="px-2.5 sm:px-3 py-1 text-xs sm:text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full flex items-center space-x-1.5 sm:space-x-2">
                  <span>{spec}</span>
          ...
          {/* Languages */}
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Languages</h2>
            <div className="flex gap-2">
              <input
                type="text"
                value={languageInput}
            ...
            <div className="flex flex-wrap gap-2">
              {formData.languages.map((lang, idx) => (
                <span key={idx} className="px-2.5 sm:px-3 py-1 text-xs sm:text-sm bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full flex items-center space-x-1.5 sm:space-x-2">
                  <span>{lang}</span>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {formData.categories.map((cat, idx) => (
                <span key={idx} className="px-2.5 sm:px-3 py-1 text-xs sm:text-sm bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full flex items-center space-x-1.5 sm:space-x-2">
                  <span>{cat}</span>
          ...
          {/* Includes */}
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">What's Included</h2>
            <div className="flex gap-2">
              <input
                type="text"
                value={includesInput}
            ...
            <div className="flex flex-wrap gap-2">
              {formData.includes.map((inc, idx) => (
                <span key={idx} className="px-2.5 sm:px-3 py-1 text-xs sm:text-sm bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 rounded-full flex items-center space-x-1.5 sm:space-x-2">
                  <span>{inc}</span>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Pricing & Availability</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                <div className="relative">
                  <DollarSign className="absolute left-3 top-2.5 sm:top-3 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
                  <input
                    type="number"
                    name="price"
              ...
              <div>
                ...
                <label className="flex items-center space-x-2 cursor-pointer mt-2">
                  ...
                  />
                  <span className="text-sm sm:text-base text-gray-700 dark:text-gray-300">Currently Available</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                <div className="relative">
                  <Facebook className="absolute left-3 top-2.5 sm:top-3 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
                  <input
                    type="text"
                    name="facebook"
              ...
              <div>
                ...
                <div className="relative">
                  <Globe className="absolute left-3 top-2.5 sm:top-3 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
                  <input
                    type="text"
                    name="website"
          ...
          {/* Images Upload */}
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Images (Maximum 2) *</h2>
            ...
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 sm:p-6 text-center hover:border-blue-500 transition-colors">
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2">Drag and drop images or click to select</p>
              <input
                type="file"
                multiple
                accept="image/*"
                ...
                id="image-upload"
              />
              <label htmlFor="image-upload" className="cursor-pointer text-sm sm:text-base text-blue-600 hover:text-blue-700 font-medium">
                Click to upload
              </label>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {images.map((img, idx) => (
                  <div key={idx} className="relative">
                    <img src={img.url} alt={`Preview ${idx}`} className="w-full h-32 sm:h-40 object-cover rounded-lg" />
                    <button
                      type="button"
          ...
          {/* PDF Upload */}
          <div className="space-y-3 sm:space-y-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">PDF Document (Optional)</h2>

            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 sm:p-6 text-center hover:border-blue-500 transition-colors">
              <FileText className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400 mx-auto mb-2" />
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2">Upload PDF document (max 50MB)</p>
              <input
                type="file"
                accept=".pdf"
              ...
              />
              <label htmlFor="pdf-upload" className="cursor-pointer text-sm sm:text-base text-blue-600 hover:text-blue-700 font-medium">
                {pdfDocument.uploading ? 'Uploading...' : 'Click to upload PDF'}
              </label>
            </div>

            {pdfDocument.url && (
              <div className="p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <FileText className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
                  <span className="text-xs sm:text-sm text-green-700 dark:text-green-300 truncate">{pdfDocument.fileName}</span>
                </div>
                <button
                  type="button"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:flex-1 px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all font-medium flex items-center justify-center space-x-2 disabled:opacity-50"
            >
              {loading ? (
                <>
      ...
      {showSuccessModal && (
        <SuccessModal
          ...
          message="Your book/magazine has been published and is now visible to users."
...
export default BooksAndMagazinesEducationalForm;

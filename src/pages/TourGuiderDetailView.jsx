...
const TourGuiderDetailView = () => {
  ...
  const fetchTourGuider = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/tour-guider/${tourGuiderId}`);
  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get(`http://localhost:5000/api/tour-guider/${tourGuiderId}/reviews?page=1&limit=10`);
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/tour-guider/${tourGuiderId}/review`, {
        method: 'POST',
        headers: {

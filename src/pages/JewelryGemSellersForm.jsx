...
const JewelryGemSellersForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/jewelry-gem-sellers/publish', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-amber-600 to-orange-600 p-8 text-white">
            <h1 className="text-3xl font-bold mb-2">Jewelry & Gem Seller Profile</h1>
            <p className="text-amber-100">Publish your jewelry and gemstone business</p>
          </div>

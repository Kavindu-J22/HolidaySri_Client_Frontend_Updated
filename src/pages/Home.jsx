...
const Home = () => {
  ...
  const appData = {
    "Top": [
      ...
      { name: "Rent Land", path: "/rent-land-camping-parking", icon: TreePine, bgImage: "https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?w=400&h=400&fit=crop", color: "from-lime-500/60 to-green-500/60", iconColor: "text-lime-600 dark:text-lime-400" },
      { name: "Membership", path: "/ads/essential/pricing-memberships", icon: Star, bgImage: "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=400&h=400&fit=crop", color: "from-yellow-500/60 to-amber-500/60", iconColor: "text-yellow-600 dark:text-yellow-400" },
    ],
    "Tourism And Travel": [

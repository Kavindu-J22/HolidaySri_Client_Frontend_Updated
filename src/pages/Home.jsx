...
const Home = () => {
  ...
  const appData = {
    ...
    "Tourism And Travel": [
      { name: "Explore Locations", path: "/explore-locations", icon: MapPin, bgImage: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=400&h=400&fit=crop", color: "from-blue-500/60 to-cyan-500/60", iconColor: "text-blue-600 dark:text-blue-400" },
      ...
      { name: "Rent a Land for Camping or Parking purposes", path: "/rent-land-camping-parking", icon: TreePine, bgImage: "https://images.unsplash.com/photo-1506197603052-3cc9c3a201bd?w=400&h=400&fit=crop", color: "from-lime-500/60 to-green-500/60", iconColor: "text-lime-600 dark:text-lime-400" },
    ],
    "Accommodation & Dining": [
    ...
    "Professionals & Services": [
      ...
      { name: "Currency Exchange Rates & Services", path: "/currency-exchange", icon: CreditCard, bgImage: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=400&h=400&fit=crop", color: "from-emerald-500/60 to-teal-500/60", iconColor: "text-emerald-600 dark:text-emerald-400" },
    ...
    "Caring & Donations": [
      { name: "Compassionate Caregivers & Earn Time Currency", path: "/caregivers-time-currency-browse", icon: HandHeart, bgImage: "https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=400&h=400&fit=crop", color: "from-rose-500/60 to-pink-500/60", iconColor: "text-rose-600 dark:text-rose-400" },
      ...
      { name: "Donations / Raise Your Fund", path: "/donations-raise-fund-browse", icon: Heart, bgImage: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&h=400&fit=crop", color: "from-red-500/60 to-rose-500/60", iconColor: "text-red-600 dark:text-red-400" },
    ],
    "Marketplace & Shopping": [
      ...
      { name: "Souvenirs & Collectibles", path: "/ads/marketplace/souvenirs", icon: Camera, bgImage: "https://images.unsplash.com/photo-1488085061387-422e29b40080?w=400&h=400&fit=crop", color: "from-amber-500/60 to-orange-500/60", iconColor: "text-amber-600 dark:text-amber-400" },
      ...
      { name: "Other Items", path: "/other-items", icon: Package, bgImage: "https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=400&h=400&fit=crop", color: "from-gray-500/60 to-slate-500/60", iconColor: "text-gray-600 dark:text-gray-400" },
    ],
    "Entertainment & Fitness": [

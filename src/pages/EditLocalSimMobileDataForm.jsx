...
const EditLocalSimMobileDataForm = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:5000/api/local-sim-mobile-data/${id}`, {
          headers: {
        ...
        if (data.success) {
          ...
          if (profile.packagesPDF) {
            setPackagesPDF({
              url: profile.packagesPDF.url || '',
              publicId: profile.packagesPDF.publicId || '',
              fileName: profile.packagesPDF.fileName || '',
              uploading: false
            });
          }
        } else {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            Edit Local SIM & Mobile Data Advertisement
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Update your local SIM and mobile data service advertisement details
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                  Your Local SIM & Mobile Data advertisement has been updated.
                </p>
                <div className="mt-4">
...
export default EditLocalSimMobileDataForm;

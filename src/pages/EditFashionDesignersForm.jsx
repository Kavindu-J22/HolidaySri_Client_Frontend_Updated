...
const EditFashionDesignersForm = () => {
      ...
      <div className="max-w-4xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8">
          ...
          <div className="text-center">
            <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-1.5 sm:mb-2">
              Edit Fashion Designer Profile
            </h1>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Update your fashion design expertise and portfolio
            </p>
          </div>
        </div>
        ...
        {showSuccessModal && (
          <SuccessModal
            ...
            message="Your fashion designer profile has been updated."
...
export default EditFashionDesignersForm;

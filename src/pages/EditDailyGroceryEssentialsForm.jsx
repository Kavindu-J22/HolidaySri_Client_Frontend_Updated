...
const EditDailyGroceryEssentialsForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch provinces
        const provincesResponse = await fetch('http://localhost:5000/api/daily-grocery-essentials/provinces');
        ...
        // Fetch listing data
        const listingResponse = await fetch(`http://localhost:5000/api/daily-grocery-essentials/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/daily-grocery-essentials/${id}`, {
        method: 'PUT',
        headers: {
